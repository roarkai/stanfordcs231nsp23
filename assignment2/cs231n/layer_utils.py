...
def classic_layer_forward(x, w, b, gamma, beta, bn_param, dp_param, last_layer_flag):
    """
    the classic layer has the architecture as:
    ...
    if not last_layer_flag: # then ReLU would be done
        # batchnorm or not
    ...
    # package cache for backward
    cache = (fc_cache, relu_cache, bn_cache, ln_cache, dp_cache)    
